<template>
    <transition name="mu-dialog-slide" @after-enter="show()" @after-leave="hide()">
        <div v-show="ifShow" class="sk-win-container transition" :class="titleClass" @click="onClickContainer" :style="{left: routeView.left + 'px', top: routeView.top + 'px'}">
            <div class="sk-win-content" :style="{width: width, height: height}">
                <div class="title-con">
                    <div>
